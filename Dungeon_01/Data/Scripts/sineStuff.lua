...
function Tick(deltaTime)
	...
	local newPositionOffset = Vector3.New(0, 0, sineTranslationValue)
	
	local sineTranslationValue2 = GetValue(2, 100, 0)
	local newPositionOffset2 = Vector3.New(0, 0, sineTranslationValue2)
	...
	local sineRotationValue = GetValue(.5, 2, 0)
