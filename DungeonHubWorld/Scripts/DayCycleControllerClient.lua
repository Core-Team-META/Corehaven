...
local DAY_SKY_DOME_ZENITH_COLOR = Color.New(0.0, 0.12, 0.69, 0.886)
...
-- Night
local NIGHT_FOG_DENSITY = 1.5
local NIGHT_FOG_FALLOFF = 0.2
local NIGHT_FOG_START = 3000
