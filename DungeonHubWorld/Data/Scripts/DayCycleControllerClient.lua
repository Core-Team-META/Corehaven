...
local DAY_SUNLIGHT_INTENSITY = 2.5
local DAY_SUNLIGHT_COLOR = Color.New(1.0, 0.95, 0.73)
...
local DUSK_SKY_DOME_HORIZON_COLOR = Color.New(0.31,0.13,0.87)
local DUSK_SKY_DOME_HAZE_COLOR = Color.New(0.73,0.097,0.0)
local DUSK_SKYLIGHT_INTENSITY = 1.5
local DUSK_SKYLIGHT_TINT_COLOR = Color.New(0.5, 0.48, 0.75)
local DUSK_STAR_DOME_VISIBILITY = 0.02
local DUSK_SUNLIGHT_INTENSITY = 1.5
local DUSK_SUNLIGHT_COLOR = Color.New(0.98, 0.25, 0.0)
local DUSK_SUNLIGHT_DISC_COLOR = Color.New(0.98, 0.25, 0.0)
local DUSK_SUNDISC_SIZE = 40.0
local DUSK_MOON_SIZE = 4.0
-- Night
local NIGHT_FOG_DENSITY = 2
local NIGHT_FOG_FALLOFF = 0.2
local NIGHT_FOG_START = 3000.0
local NIGHT_FOG_OPACITY = 0.08
local NIGHT_SKY_DOME_ZENITH_COLOR = Color.New(0.0, 0.005, 0.12, 1.0)
local NIGHT_SKY_DOME_HORIZON_COLOR = Color.New(0.0,0.12,0.69, 0.886)
local NIGHT_SKY_DOME_HAZE_COLOR = Color.New(0.0,0.04,0.47, 1.0)
local NIGHT_SKYLIGHT_INTENSITY = 1.5
local NIGHT_SKYLIGHT_TINT_COLOR = Color.New(0.1, 0.31, 0.78)
local NIGHT_STAR_DOME_VISIBILITY = 1.0
local NIGHT_SUNLIGHT_INTENSITY = 0.5
local NIGHT_SUNLIGHT_COLOR = Color.New(0.22, 0.72, 1.0)
local NIGHT_SUNLIGHT_DISC_COLOR = Color.New(1.0, 0.96, 0.74)
local NIGHT_SUNDISC_SIZE =20.0
local NIGHT_MOON_SIZE = 3.0
-- Dawn
local DAWN_FOG_DENSITY = 2
...
local DAWN_SKY_DOME_HORIZON_COLOR = Color.New(0.73,0.097,0.0)
...
local DAWN_SUNLIGHT_INTENSITY = 2.5
local DAWN_SUNLIGHT_COLOR = Color.New(0.98, 0.25, 0.0)
local DAWN_SUNLIGHT_DISC_COLOR = Color.New(1, 0.44, 0.13)
local DAWN_SUNDISC_SIZE = 40.0
local DAWN_MOON_SIZE = 4.0
